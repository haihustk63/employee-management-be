...
const getAllJobs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const jobs = yield getJobsWithParams(req.query);
    const jobsWithoutLimit = yield getJobsWithParams(req.query, false);
    const response = {
        page: +page,
        limit: +limit,
        data: jobs,
        total: jobsWithoutLimit === null || jobsWithoutLimit === void 0 ? void 0 : jobsWithoutLimit.length,
    };
    return res.status(200).send(response);
});
exports.getAllJobs = getAllJobs;
const getJobsWithParams = (query, withLimit = true) => {
    ...
    return prisma.$queryRaw `
      ...
      WHERE 1
      ${keyword ? client_1.Prisma.sql `AND title LIKE ${`%${keyword}%`}` : client_1.Prisma.empty}
      ...
      ${limit && withLimit ? client_1.Prisma.sql `LIMIT ${page}` : client_1.Prisma.empty}
      ${page && withLimit
