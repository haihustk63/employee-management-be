...
const getAllApplications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const applications = yield getApplicationsWithParams(req.query);
    const applicationsWithoutLimit = yield getApplicationsWithParams(req.query, false);
    const response = {
        page: +page,
        limit: +limit,
        data: applications,
        total: applicationsWithoutLimit === null || applicationsWithoutLimit === void 0 ? void 0 : applicationsWithoutLimit.length,
    };
    return res.status(200).send(response);
});
exports.getAllApplications = getAllApplications;
const getApplicationsWithParams = (query, withLimit = true) => {
    ...
    return prisma.candidate.findMany(Object.assign({ where: whereExtraQuery, include: {
            job: true,
            interviewer: true,
            employeeAccount: {
                select: {
