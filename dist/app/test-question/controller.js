...
const getAllTestQuestions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const testQuestions = yield getQuestionsWithParams(req.query, true);
        const testQuestionsWithoutLimit = yield getQuestionsWithParams(req.query, false);
        const responseData = {
            data: testQuestions,
            page: +page,
            limit: +limit,
            total: testQuestionsWithoutLimit === null || testQuestionsWithoutLimit === void 0 ? void 0 : testQuestionsWithoutLimit.length,
        };
...
const getQuestionsWithParams = (query, withLimit) => __awaiter(void 0, void 0, void 0, function* () {
    const { keyword = "", topic, level, type, page = 1, limit = 10, questionTextSort, } = query;
    ...
    ${questionTextSort
        ? +questionTextSort === common_1.SORT_ORDER.ascend.value
            ? client_1.Prisma.sql `ORDER BY tq.question_text ASC`
            : client_1.Prisma.sql `ORDER BY tq.question_text DESC`
        : client_1.Prisma.empty}
