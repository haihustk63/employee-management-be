...
exports.ROUTES = {
    ...
    // firebase
    FIREBASE_ACCOUNT: exports.BASE_URLS.FIREBASE_ACCOUNT,
    FIREBASE_ACCOUNT_LOGIN: `${exports.BASE_URLS.FIREBASE_ACCOUNT}/login`,
};
...
const routeEmployee = {
    ...
    [exports.ROUTES.CONTESTANT_TEST_MODIFY]: ["GET", "PATCH"],
    [exports.ROUTES.SUBMIT_TEST]: ["POST"],
    [exports.ROUTES.FIREBASE_ACCOUNT]: ["POST"],
};
