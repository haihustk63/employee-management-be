...
export const ROUTES = {
  ...
  CHANGE_PASSWORDS: `${BASE_URLS.ACCOUNT}/change-password`,
  ...
  // statistics
  APPLICATION_STATISTICS: `${BASE_URLS.STATISTICS}/applications`,
  CANDIDATE_STATISTICS: `${BASE_URLS.STATISTICS}/candidates`,
